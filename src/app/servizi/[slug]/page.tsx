...
const servicesData: Record<string, ServiceData> = {
  "crescita-personale": {
    ...
    benefits: [
      "Avrai maggiore consapevolezza dei tuoi pensieri",
      "Migliorerai la tua autostima, più sicuro/a di chi sei",
      "Sentirai sollievo con la Mindfulness e strategie per gestire lo stress",
      "Avrai più chiarezza suoi tuoi prossimi obiettivi",
      "Supererai blocchi e convinzioni limitanti che non permettono di fare quel passo che desideri",
      "Sarai più forte nella tua resilienza, accettando comunque tutte le tue parti più fragili",
    ],
  ...
  "orientamento-scelta": {
    ...
    benefits: [
      "Sai più chiaro su cosa vuoi davvero e su cosa conta per te",
      "Agirai in maniera più consapevole delle possibilità che hai",
      "Più sicuro nel prendere decisioni anche lavorative, senza il peso del dubbio costante",
      "Più capace di pensare in maniera logica e sana valutando per ogni situazione il pro e il contro",
      "In sintonia con le tue scelte, perché saranno davvero tue — allineate ai tuoi valori e a chi sei",
      "Scouting e inserimento nel mondo del lavoro",
    ],
